...
admin.factory('layoutService',['$http',function($http){
    return {
        ...
        saveListLayout: function(layoutId,searchCriteriaFields,searchRecordFields,actionButtonCriteria,sObjectLayoutId,sObjectLayoutWhereClause,searchCriteriaDeletedFields,searchResultDeletedFields){
            // var fieldsToDelete = [];
            var _index = 0;
